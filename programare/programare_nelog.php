...
if(isset($_POST['update_profile'])){
   ...
   if (empty($_POST['update_name']) || empty($_POST['update_email']) || empty($_POST['update_phone']) || empty($_POST['update_address']) || empty($_POST['class']) || empty($_POST['instructor']) || empty($_POST['hour'])) {
  ...
  <nav>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
         <span>Telefon:</span>
            <input type="phone" name="update_phone" class="box">
            <span>Adresa:</span>
            <input type="text" name="update_address" class="box">
