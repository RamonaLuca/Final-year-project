  ...
  <nav>
    ...
    <section class="schedule" id="schedule">
  	 	  <div class="content">
                ...
                <div class="text">
                    <div id = "leftbox">  
                      <a href="#"><em>Clase</em></a>
                    </div>
                    <div id = "middlebox">  
                      <a href="orar_cross.php"><em>Cross-training</em></a>
                    </div>
                    <div id = "rightbox">  
                   ...
                   <table class="table">
                      ...
                      <td class="hour"></td>
                        ...
                        <td><strong>Vineri</strong></td>
                   	 	...
                   	 	<tr>
                   	 		<td class="hour">8:00-8:30</td>
                   	 		  <td></td>
                   	 		  <td></td>
                   	 		  <td rowspan="2"><span>Circuit Training</span><br/>Raluca Nica</td>
                          <td></td>
                          <td rowspan="2"><span>Circuit Training</span><br/>Raluca Nica</td>
                   	 	</tr>
                   	 	<tr>
                   	 		<td class="hour">8:30-9:00</td>
                   	 		<td></td>
                   	 		<td></td>
                   	 		<td</td>
                   	 	</tr>
                   	 	<tr>
                   	 		...
                   	 		<td rowspan="2"><span>Body Shape</span><br/>Adrian Floruț</td>
                   	 		<td rowspan="2"><span>ABS Workout</span><br/>Adrian Floruț</td>
                   	 		<td rowspan="2"><span>Step tone</span><br/>Adrian Floruț</td>
                        <td rowspan="2"><span>Burning Cardio</span><br/>Adrian Floruț</td>
                        <td rowspan="2"><span>Mix Workout</span><br/>Adrian Floruț</td>
                   	 	</tr>
                   	 	<tr>
                        ...
                        <td></td>
                   	 		<td rowspan="2"><span>Pilates</span><br/>Roxana Mănucu</td>
                   	 		<td></td>
                        <td rowspan="2"><span>Pilates</span><br/>Roxana Mănucu</td>
                        <td></td>
                   	 	</tr>
                      ...
                      <tr>
                   	 		...
                   	 		<td></td>
                   	 		<td rowspan="2"><span>Cardio Dance</span><br/>Jennifer Bartok</td>
                   	 		<td></td>
                        <td rowspan="2"><span>Cardio Dance</span><br/>Jennifer Bartok</td>
                        <td></td>
                      <tr>
